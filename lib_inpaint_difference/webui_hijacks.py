...
def hijack_StableDiffusionProcessingImg2Img__init__():
    original_StableDiffusionProcessingImg2Img__init__ = img2img.StableDiffusionProcessingImg2Img.__init__
    ...
    img2img.StableDiffusionProcessingImg2Img.__init__ = hijack_func
